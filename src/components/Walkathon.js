...
import prototypeA from '../img/VirtualWalkathon/Prototype A.svg';
import prototypeB from '../img/VirtualWalkathon/Prototype B.svg';
    ...
    return (
        <div className="caseStudy">
            ...
            <div className='ab'>
                <div id='prototypeA'>
                    <h3>Prototype A</h3>
                    <img src={prototypeA} className="" alt="Virtual Walkathon Protoytpe A" />
                </div>
                <div id='prototypeB'>
                    <h3>Prototype B</h3>
                    <img src={prototypeB} className="" alt="Virtual Walkathon Protoytpe B" />
                </div>
            </div>
            <a></a>
